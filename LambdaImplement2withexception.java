...
public class LambdaImplement2withexception {
	...
	public static void main(String args[])
	{
		...
		LambdaImplement2withexception liobj2=new LambdaImplement2withexception(); 
		...
		//System.out.println("Division operation(a/b): "+liobj2.functionoutofmain(num1, num2, ifobjplusfunctiondiv));
